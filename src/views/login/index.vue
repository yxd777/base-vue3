<!--
 * @Author: yxd
 * @Date: 2023-05-21 13:48:40
 * @LastEditors: ad ad@zhun-shi.com
 * @LastEditTime: 2023-05-21 22:34:44
 * @Description: 
-->
<template>
  <div flex h-full>
    <div m-auto bg-red-100 w-350 flex flex-col items-center border border-gray-300 p-30 rounded-10>
      <h5 text-24 font-normal color="#6a6a6a">
        {{ title }}
      </h5>
      <div mt-30 w-full>
        <n-input v-model:value="loginInfo.name" autofocus class="text-16 items-center h-50 pl-10" placeholder="admin"
          :maxlength="20">
        </n-input>
      </div>
      <div mt-30 w-full>
